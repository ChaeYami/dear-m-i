...
export const QUERY_KEYS = {
  ...
  medicationDetail: (id: string) => ['medication', id] as const,
  ...
  allMedicationSchedules: () => ['allMedicationSchedules'] as const,
  ...
  medicationSlotGroups: () => ['medicationSlotGroups'] as const,

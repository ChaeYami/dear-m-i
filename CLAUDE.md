...
S3(Presigned), Expo Push (Firebase 제거됨), Gemini Vision(처방전 OCR — Google `gemini-2.5-flash`, fallback pro/flash-lite), 식약처 의약품 제품 허가정보 API(약품 30일 캐시), IAP(App Store / Play Billing).
